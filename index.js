...
client.on("message", async (message) => {
    ...
    if (command === "30092007022514111014002117O492618820"){
        message.react('☑️')
    ...
    if (command === "30092007022514111014002117O4926188207512092020"){
        message.react('☑️')
    ...
    if (command === "30092007022514111014002117O49261882075120920201010108"){
        message.react('☑️')
